...
export const goalInputTranslations = {
  en: {
    ...
    goat: 'Start goat farming',
    duck: 'Start duck farming',
    pension: 'Get farmer pension',
    insurance: 'Get crop insurance',
  ...
  or: {
    startBusiness: 'ବ୍ୟବସାୟ ଆରମ୍ଭ କରିବା',
    goat: 'ଛେଳି ଚାଷ ଆରମ୍ଭ କରିବା',
    duck: 'ବତକ ଚାଷ ଆରମ୍ଭ କରିବା',
    pension: 'ଚାଷୀ ପେନ୍ସନ ପାଇବା',
    insurance: 'ଫସଲ ବୀମା ପାଇବା',
